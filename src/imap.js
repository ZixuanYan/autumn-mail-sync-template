...
function planFetch(mailbox, meta, sinceDays) {
  ...
  if (!lastUid || validityChanged) {
    ...
    return { mode: 'since', since, resetWatermark: validityChanged, uidValidity };
  }
  return { mode: 'uid', startUid: lastUid + 1, uidValidity };
}
